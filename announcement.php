...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#announce">
        Create Announcement
      </button>
            ...
            <div class="modal-body">
              <form action="process.php" method="POST">
                ...
                <div class="row">
                  ...
                  <input type="submit" name="create_announcement" class="btn btn-primary form-control" value="POST">
                </div>
              </form>
            </div>
          </div>
      ...
      <div class="row mt-2">
        <?php
        $get_announce = mysqli_query($conn, "SELECT * FROM announcements");
        while ($announce = mysqli_fetch_array($get_announce)) {


        ?>
          <div class="col-md-4">
            <div class="card shadow">
              <h5 class="card-header fw-bold"><?php echo $announce['title']; ?></h5>
              <div class="card-body  p-2">
                <p><?php echo $announce['message']; ?></p>
                <p>Date Posted:<?php echo $announce['date']; ?></p>
              </div>
              <div class="card-footer">

                <a type="submit" data-bs-toggle="modal" data-bs-target="#upd_announce<?php echo $announce['id']; ?>" class="">View More</a>

                <div class="modal" id="upd_announce<?php echo $announce['id']; ?>" tabindex="-1">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Create Announcement</h5>
                      ...
                      <div class="modal-body">
                        <form action="process.php?id=<?php echo $announce['id']; ?>" method="POST">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                              ...
                              <div class="input-group">
                                <div class="input-group-text"><i class="bi bi-text"></i></div>
                                <input type="text" name="title" value="<?php echo $announce['title']; ?>" class="form-control" placeholder="Announcement Title">
                              </div>
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                              ...
                              <div class="input-group">
                                <div class="input-group-text"><i class="bi bi-text"></i></div>
                                <textarea name="message" value="" class="form-control" style="resize:none;"><?php echo $announce['message']; ?></textarea>
                              </div>
                            ...
                            <div class="d-grid gap-2">
                              <input type="submit" name="upd_announce" class="btn btn-success form-control" value="Save Changes">
                              <input type="submit" name="del_announce" class="btn btn-danger " onclick="return confirm('Do you want to delete this announcement?')" value="Delete">
                            </div>
                          </div>
                        </form>
                      </div>
